 ...
 * @returns {string} The HEX representation (i.e., #nnnnnn)
 */
export const findClosestAccessibleColor = (foregroundColor: string, backgroundColor: string, minContrastRatio = 3) => {
    ...
    const isLightBackground = getContrastRatio("#000", backgroundColor) >= minContrastRatio;
    const isDarkBackground = getContrastRatio("#fff", backgroundColor) >= minContrastRatio;
