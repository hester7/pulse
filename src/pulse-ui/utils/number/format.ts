 ...
 */
export const formatPercent = (value: number, options = {}, locales = "en") =>
 ...
 */
export const formatCurrency = (value: number, options = {}, locales = "en") => Intl.NumberFormat(locales, { style: "currency", ...options }).format(value);
 ...
 *                                                     ]
 */
export const formatCurrencyToParts = (value: number, options = {}, locales = "en") => Intl.NumberFormat(locales, { style: "currency", ...options }).formatToParts(value);
 ...
 */
export const formatCurrencyUsingCompactNotation = (value: number, options = {}, locales = "en") =>
 ...
 */
export const formatDecimalUnitUsingCompactNotation = (value: number, options = {}, locales = "en") =>
    new Intl.NumberFormat(locales, {
        style: "decimal",
        notation: "compact",
        compactDisplay: "short",
